        ...
        <footer>
            <div className={"max-w-300 w-full mx-auto px-4 py-6 xl:px-0"}>
                <div className={"flex flex-col gap-4 sm:flex-row justify-between"}>
                    <div>
                        <div className={"flex flex-row justify-center sm:justify-start gap-2 items-center "}>
                            <Image alt={"Navbar Icon"} width={"32"} height={"32"} src={"/icon.png"} />
                            <h2 className="font-bold text-center sm:text-start text-2xl">Savoria</h2>
                        </div>
                        <p className={"max-w-101.25 mt-2 mx-auto sm:mx-0 text-muted-foreground text-[15px] text-center sm:text-start"}>Experience the art of dining. Located in the heart of the Food District.</p>
                    </div>
                    <div className={"grid gap-12 grid-cols-2"}>
                        <div className={"flex flex-col text-center sm:text-start gap-1 text-muted-foreground"}>
